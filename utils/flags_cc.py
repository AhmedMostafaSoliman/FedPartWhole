...
flags.DEFINE_string('dataset', 'IMAGENETTE', 'Dataset name.')
flags.DEFINE_string('exp_name', 'IMAGENETTE', 'Experiment name.')
...
flags.DEFINE_integer('levels_recon', 2, 'How many columns to reconstruct in the pre-training.') 
...
flags.DEFINE_bool('levels_encoder', False, 'Use an encoder for Agglomerator\'s levels.')
